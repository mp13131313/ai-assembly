...
**Current state (2026-05-03):** athens-2026 has 7 of 10 panel voices shipped (Plato, Cleopatra, Dostoevsky, Battuta, Octopus, Hannah Arendt, Ada Lovelace); Marley pipeline mid-flight; Whanganui + Scheherazade awaiting operator DR sessions. `council_config.json` wired with 7 real provocateur profiles.
