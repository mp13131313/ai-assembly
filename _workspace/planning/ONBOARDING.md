...
- **No epistemic-honesty / decline-to-engage hooks in `voice_temporal_stance.default`.** Phrases like "where the framework does not reach, say so" / "name the gap" / "name the silence" / "I say so" — and any other "you may admit not-knowing" escape clause attached to the translation_protocol sentence — cause voices to **default to decline-to-engage behavior** (use the hook as escape from substantive engagement). Operator confirmed pattern from prior shipping. Removed across all 10 voices 2026-05-08 (athens-2026 `b2d5eaf`); standing rule going forward — not to be re-introduced. If a voice genuinely refuses on a specific topic, that's a `topics_requiring_care` / `hard_limits` concern, not a generic temporal_stance hook. See voices/OPEN_ITEMS §31 Gap-K.
...
**Sessions 2026-05-05 evening + 2026-05-06 archive sweep:** six superseded planning docs (their content migrated into authoritative `voices/OPEN_ITEMS.md` sections §27–§31 + status headers added before move) were archived to `_workspace/archive/session-artifacts/`: `WHANGANUI_V2_PLAN_2026-05-05.md`, `WHANGANUI_V2_ROUND0_WALKTHROUGH_2026-05-05.md`, `MEMO_2026_05_05_voice_temporal_stance_assembly_fiction.md`, `MEMO_2026_05_05_length_cap_card_surgery_after_runtime_fix.md`, `MEMO_2026_05_01_recurrence_patterns_from_legitimacy_test.md`, `CLAUDIA_PINCHBECK_PERSONA_PREP_2026-05-03.md`.

**2026-05-29 post-Athens archive sweep:** four more `voices/` docs archived to `_workspace/archive/session-artifacts/` once Athens published + their findings actioned or status resolved: `MEMO_2026_05_07_card_patches_from_external_reader.md` (§A.9 superseded by §31 Gap-K rewrite; §B/§D Gap-H/I/J folded into §31; §A.1–A.8 individual card-patch slips remain as v4.1 worked-from list — see §31 archive pointer), `TIM_LEBERECHT_CARD_REVIEW_2026-05-05.md` (one-off review; Tim performed across N1–N3 = empirical validation), `VIDEO_TEAM_CONSTRAINT_SHEET_2026-05-04.md` (closing-show video done; constraint sheet served its purpose), `MARLEY_READINESS_PARAGRAPHS_2026-05-04.md` (D1/E1 drafts; status resolved — see voices/HANDOFF.md if re-purposing for the post-Athens Rastafari-orbit reader gate per §24).

**Active `voices/` planning docs after both sweeps:** `HANDOFF.md`, `ONBOARDING.md`, `OPEN_ITEMS.md` (the three durable workstream files).
