...
| Voice of the Octopus | non_human | observational | false | ✅ **compass-rebuild shipped 2026-05-02** (`1d8605f`); 4 rounds + 16 patches; chat-test verified two-channel JSON+prose emission contract. Runtime asset bundle at `code/runtime/assets/octopus_chromatophore/`. See §15 below. |
