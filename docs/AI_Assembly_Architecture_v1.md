...
| **Persona Pipeline** | `AI_Assembly_Persona_Pipeline_v3_7.md` | Automated agent pipeline for building each voice. 7 passes, 4 models, parallel across 12 voices. Runs pre-conference. |
...
- **How to build a voice** (research, quality standards, prompt templates) → `AI_Assembly_Persona_Pipeline_v3_7.md`
