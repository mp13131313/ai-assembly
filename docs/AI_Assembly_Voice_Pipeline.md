...
- `_workspace/archive/2026-04-27_current_state_snapshot/CURRENT_STATE.md` — gap analysis + critical path; Voice Pipeline is Phase D (this spec lands; build follows)
