...
| `AI_Assembly_Persona_Pipeline_v3_8.md` | **Current** | Persona build pipeline v3.8 (walkthrough fixes 2026-04-17). |
| `AI_Assembly_Persona_Pipeline_v3_7.md` | **Superseded** | Superseded by v3.8. |
