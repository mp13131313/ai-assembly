...
OUTPUT FORMAT: A research dossier only. Do NOT produce a persona card, a "Field 01:" structure, or any "Block" headings. The output must have exactly six numbered section headings matching the list above. Cite major claims — author + work minimum; year only where load-bearing. For consensus readings, one canonical citation is sufficient. Depth and citation quality matter more than length — produce substantive coverage of each section, not padding. This dossier will be used as raw research material for building an AI voice; scholarly depth and citation quality determine the quality of the voice.
